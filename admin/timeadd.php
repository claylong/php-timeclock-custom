...
elseif ($request == 'POST') {
	...
	$post_datetime = DateTime::createFromFormat($datefmt." ".$timefmt, $post_date." ".$post_time);
	...
	($post_date_errors['error_count'] > 0)) {
		$evil_post = '1';
		if (empty($post_date)) {
			echo "            <table align=center class=table_border width=60% border=0 cellpadding=0 cellspacing=3>\n";
			echo "              <tr>\n";
			echo "                <td class=table_rows width=20 align=center><img src='../images/icons/cancel.png' /></td><td class=table_rows_red>
                    A Date is required.</td></tr>\n";
			echo "            </table>\n";
		}
		...
		elseif ($post_date_errors['error_count'] > 0) {
			echo "            <table align=center class=table_border width=60% border=0 cellpadding=0 cellspacing=3>\n";
			echo "              <tr>\n";
			echo "                <td class=table_rows width=20 align=center><img src='../images/icons/cancel.png' /></td><td class=table_rows_red>
                    A valid Date and Time are required in the proper format.</td></tr>\n";
			echo "            </table>\n";
		}
	} // end if
...
colspan=2 width=80% style='padding-left:20px;'>".$post_datetime->format($datefmt)."</td></tr>\n";
		echo "              <tr><td class=table_rows height=25 width=20% style='padding-left:32px;' nowrap>Time:</td><td align=left class=table_rows
colspan=2 width=80% style='padding-left:20px;'>".$post_datetime->format($timefmt)."</td></tr>\n";
